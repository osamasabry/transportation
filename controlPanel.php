            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="service_wrapper">
                        ...
                        <div class="service_slider">
                            ...
                            <div class="single_service_wrapper">
                                <div class="service_img">
                                    <img src="images/search.png" alt="service-img">
                                </div>
                                <div class="service_content">
                                    <div class="service_title">
                                        <a href="categorySearch.html"><h3>search </h3></a>
                                    </div>
                            ...
                            <div class="single_service_wrapper">
                                <div class="service_img">
                                    <img src="images/add.png" alt="service-img">
                                </div>
                                <div class="service_content">
                                    <div class="service_title">
                                        <a href="categoryAdd.html"><h3>Add</h3></a>
                                    </div>
                                    <div class="service_text">
                                        <p>You have all permissions. </p>
                                    </div>
                        ...
                        <div class="single_service_wrapper">
                                <div class="service_img">
                                    <img src="images/demo4.png" alt="service-img">
                                </div>
                                <div class="service_content">
                                    <div class="service_title">
                                        <a href="categoryEdit.html"><h3>Edit</h3></a>
                                    </div>
                                    <div class="service_text">
                                        <p>You have all permission. </p>
                                    </div>
                            ...
                            <div class="single_service_wrapper">
                                <div class="service_img">
                                    <img src="images/delete.png" alt="service-img">
                                </div>
                                <div class="service_content">
                                    <div class="service_title">
                                        <a href="categorydelete.html"><h3>Delete </h3></a>
                                    </div>
                                    <div class="service_text">
                                        <p>You have all permission. </p>
                                    </div>
