                ...
                <div class="col-md-10 col-sm-10 col-sm-offset-1 col-md-offset-1">
                    <div class="quote_requ_wrapper">
                        <div class="section_title title_center">
                            <div class="title"><h2>Driver Details</h2></div>
                        </div>
                        ...
                        <div class="contact_form">
                            <form action="addUser.php" method="post">
                                ...
                                <div class="contact_btn_wrapper">
                                    <button class="trust_btn qute_sbmt" type="submit" name="button"><?php isset($_GET['id']) ? print_r('Edit Driver') : print_r('Add Driver'); ?></button>
                                </div>
                            </form>
                        </div>
                    </div><!--  -->
