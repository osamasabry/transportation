<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $sql=("SELECT * FROM trucks WHERE id =".$_GET['id']);
        $result=mysqli_query($link,$sql);
        $truck = mysqli_fetch_array($result);
                ...
                <div class="col-md-10 col-sm-10 col-sm-offset-1 col-md-offset-1">
                    <div class="quote_requ_wrapper">
                        <div class="section_title title_center">
                            <div class="title"><h2>Truck details</h2></div>
                        </div>
                        ...
                        <div class="contact_form">
                            <form action="addTruck.php" method="post">
                                ...
                                <div class="contact_btn_wrapper">
                                    <button class="trust_btn qute_sbmt" type="submit" name="button"><?php isset($_GET['id']) ? print_r('Edit Truck') : print_r('Add Truck'); ?></button>
                                </div>
                            </form>
                        </div>
                    </div><!--  -->
