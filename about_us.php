                        ...
                        <div>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fadeInUpShort animated active" id="mission">
                                    ...
                                    <p> Our mission is to create value to our clients by delivering innovative tailored solutions to move products and information more efficiently and effectively with the best people, systems and processes, and which is fully supportive of all aspects of economic development at the national level.
 </p>
                                        <p>provide professional and efficient transportation service and to eliminate the logestic problem of our customers.</p>
                                </div>
                                <div role="tabpanel" class="tab-pane fadeInUpShort animated" id="vision">
                                    ...
                                    <p>To be recognized as one of the most admired companies in our industry because of our commitments to clients, employees and business partners.</p>
                                        <p>to be integrated transportation company and become a leader of truck transportation companies in middle east, A customer-driven profitable transport company, providing a mix of environmentally friendly services by  empowered employees who are results oriented.
</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 xs_fullwidth col-xs-6">
                    ...
                    <div class="about_us_content">
                        <div class="who_we_text">
                            <p>trust company is stablished to provide a customised transport solution that includes competitive rates, an authentic approach to real customer servic and a proactive approach to meat your experience. </p>

                            <p>with an extensive of over 250 vehicles ranging in size from one tonne taxi trucks up to extendable semi trailers, crane tucks, low loader till trays, contains vehicles and many more.</p>
                        </div>
