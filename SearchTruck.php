    ...
    <section style="padding-bottom:50px;" class="get_quote section_padding reveal animated" data-delay="0.2s" data-anim="fadeInUpShort">
        ...
        <div class="container">
            ...
            <?php
                ...
                if($format=="Equal")
                    $sql=("SELECT * FROM trucks WHERE $field like '$value'");
           ...
           echo "<div class=\"demotext\" > 
           <h3> No result matches </h3></div>"; 
                         ...
                         echo "<table class=\"responstable\">
                                ...
                                $model=mysqli_result($result,$i,"model");
                                // $about=mysqli_result($result,$i,"About_truck");
